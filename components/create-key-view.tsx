...
import { ArrowLeft, Key, CheckCircle, Copy, Smartphone, CreditCard, AlertCircle, Lock, Mail, Hash, Eye, X, PlayCircle, ShieldCheck, RefreshCw, AlertTriangle } from 'lucide-react'
    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-4 bg-slate-50 relative">
        <div className="w-full max-w-md">
          ...
          {/* CARD AGRUPADO */}
          <div className="p-6 rounded-3xl bg-white border border-blue-100 shadow-xl shadow-blue-500/5 mb-4 space-y-4">
          ...
          {/* CAIXA DE AVISO BACEN (SÓ APARECE NO LINK DESBLOQUEADO ?acesso=vip) */}
          {isUnlocked && (
            <div className="p-5 rounded-3xl bg-amber-50/80 border border-amber-200 text-left space-y-3 mb-4 shadow-sm">
        ...
        {/* MODAL BACEN 399 MZN (SÓ RENDERIZA SE DESBLOQUEADO) */}
