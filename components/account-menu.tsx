  ...
  return (
    <>
      ...
      <div className="fixed left-0 top-0 bottom-0 z-[120] w-[88vw] max-w-sm bg-white text-slate-900 shadow-[20px_0_60px_-15px_rgba(15,23,42,0.08)] flex flex-col justify-between antialiased">
        ...
        <div>
          {/* Topo / Perfil do Usuário com Azul Corporativo */}
          ...
          {/* Listagem de Opções de Menu Estilo App Moderno */}
        ...
        {/* Rodapé do Menu com Versão Logada */}
      ...
      {/* Modal de Aprimoramento Exclusivo e Limpo */}
      {showUpgradeModal && (
        <>
          <div 
